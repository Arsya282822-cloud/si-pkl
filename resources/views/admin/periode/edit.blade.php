...
@section('topbar_title', 'Edit Periode PKL')
...
<div class="container-fluid px-0" style="max-width: 900px;">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h4 class="fw-bold mb-1" style="color: var(--text-main);">Edit Periode PKL</h4>
            <p class="text-muted mb-0" style="font-size: 0.875rem;">Perbarui data gelombang, rentang tanggal, atau status periode PKL.</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.periode.update', $periode) }}">
            ...
            <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                ...
                <button type="submit" class="btn btn-primary px-4 py-2 d-flex align-items-center gap-2" style="border-radius: 8px; font-weight: 600; box-shadow: 0 4px 12px rgba(14, 165, 233, 0.25);">
                    <i class="ph ph-check-circle" style="font-size: 18px;"></i> Perbarui Periode
                </button>
            </div>
        </form>
    </div>
