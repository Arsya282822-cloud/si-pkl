...
<head>
    ...
    <style>
        ...
        .page {
            width: 210mm;
            min-height: 297mm;
            /* Margins Sesuai Permintaan: Top 0.7cm, Left 2.54cm, Right 2.25cm, Bottom 0.75cm */
            padding-top: 0.7cm;
...
<div class="page">
        ...
        <div class="col-7">
            <table style="width: 100%;">
                <tr>
                    ...
                    <td>
                        <span class="editable-field px-1" contenteditable="true">904/UM/SMK-LBFU/VIII/{{ date('Y') }}</span>
                    </td>
                </tr>
                <tr>
                    <td>Lampiran</td>
                    <td>:</td>
                    <td>
                        <span class="editable-field px-1" contenteditable="true">1 (Satu) Berkas</span>
                    </td>
                </tr>
                <tr>
                    <td>Hal</td>
                    <td>:</td>
                    <td>
                        <strong class="editable-field px-1" contenteditable="true">Permohonan Praktik Kerja Lapangan (PKL)</strong>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div style="font-size: 14px; line-height: 1.55; text-align: justify;">
        ...
        <p class="editable-field mb-2" contenteditable="true">
            Dalam rangka pelaksanaan program kurikulum SMK dan peningkatan kompetensi keahlian peserta didik dengan dunia usaha dan dunia industri (DUDI), bersama ini kami mengajukan permohonan agar siswa/siswi kami dari <strong>SMK Labor Binaan FKIP UNRI Pekanbaru</strong> dapat melaksanakan kegiatan Praktik Kerja Lapangan (PKL) di perusahaan / instansi yang Bapak/Ibu pimpin.
        </p>
        
        <p class="mb-2">Adapun data peserta didik yang kami tugaskan adalah sebagai berikut:</p>

        <!-- Tabel Peserta Didik (Editable) -->
        ...
        <p class="editable-field mb-2 mt-3" contenteditable="true">
            Kegiatan PKL ini direncanakan akan berlangsung pada periode: 
            <strong>{{ $penempatan->periodePkl?->tanggal_mulai ? $penempatan->periodePkl->tanggal_mulai->translatedFormat('d F Y') : '-' }} s/d {{ $penempatan->periodePkl?->tanggal_selesai ? $penempatan->periodePkl->tanggal_selesai->translatedFormat('d F Y') : '-' }}</strong>.
        </p>

        <p class="editable-field mb-2" contenteditable="true">
            Untuk koordinasi teknis dan bimbingan, sekolah menugaskan Guru Pembimbing: 
            <strong>{{ $penempatan->guru?->nama ?: 'Guru Pembimbing Sekolah' }}</strong>.
        </p>

        <p class="editable-field mb-0" contenteditable="true">
            Demikian surat permohonan ini kami sampaikan. Atas perhatian, bantuan, dan kerja sama yang Bapak/Ibu berikan, kami ucapkan terima kasih.
        </p>
    </div>
