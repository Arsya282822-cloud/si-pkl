...
<div class="print-header">
    ...
    <div class="text-center mt-3 mb-3">
        <h4 class="fw-bold mb-0" style="text-decoration: underline; font-family: 'Plus Jakarta Sans', sans-serif; letter-spacing: -0.02em;">REKAPITULASI KEHADIRAN / ABSENSI PRAKTIK KERJA LAPANGAN (PKL)</h4>
