...
class CetakController extends Controller
{
    ...
    public function raporPkl(Penempatan $penempatan)
    {
        ...
        // Rekap kehadiran
        $absensi = AbsensiPkl::where('penempatan_id', $penempatan->id)->get();
        $rekapAbsensi = [
        ...
        $totalJurnal = JurnalPkl::where('penempatan_id', $penempatan->id)->count();
        ...
        $settings = [
            ...
            'email_sekolah' => Setting::get('sekolah_email', 'smk_labor@yahoo.com'),
            'website_sekolah' => Setting::get('sekolah_website', 'www.smklabor.sch.id'),
